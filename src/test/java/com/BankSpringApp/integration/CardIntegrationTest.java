package com.BankSpringApp.integration;

import com.BankSpringApp.BankSpringApp;
import com.BankSpringApp.TestUtils;
...
@SpringBootTest(classes = {BankSpringApp.class}, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
